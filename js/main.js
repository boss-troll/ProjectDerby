...
<b>先行</b><br>
前の集団でレースを進める脚質。<br><br>

<b>差し</b><br>
中団から最後に伸びる脚質。<br><br>

<b>追込</b><br>
後方で脚をため、最後に一気に追い込む脚質。
`
    );
...
// 予想着順
raceHorses.sort((a,b)=>
    b.predictionPower - a.predictionPower
);
...
raceHorses.forEach((horse,index)=>{
    ...
    // 人気に応じたオッズ
    const baseOdds = [
        2.3,3.4,5.2,7.8,10.5,
        14.2,18.6,23.8,31.5,42.0,
        58.0,75.0
    ];

    if(index < baseOdds.length){
...
// レース順に戻す
raceHorses.sort((a,b)=>a.number-b.number);
